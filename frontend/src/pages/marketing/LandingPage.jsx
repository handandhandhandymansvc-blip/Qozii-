...
const LandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      icon: DollarSign,
      title: '50-75% Cheaper',
      description: 'Lower costs than Thumbtack means more savings for everyone',
  ...
  const howItWorksPro = [
    ...
    { step: 2, title: 'Buy Credits', description: 'Get leads for just $10 each - 75% cheaper than competitors' },
  ...
  const testimonials = [
    {
      ...
      image: '👩',
      rating: 5,
      text: 'Found an amazing plumber in under an hour! Way cheaper than other platforms and the quality was outstanding.'
    },
    {
      name: 'Mike Davis',
      role: 'Electrician',
      image: '👨‍🔧',
      rating: 5,
      text: 'Best decision for my business! Paying only $10 per lead instead of $40+ on Thumbtack has transformed my profit margins.'
    },
    {
      name: 'Jennifer Lee',
      role: 'Homeowner',
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-100 rounded-3xl p-8 border-2 border-red-200 relative">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-red-700 font-semibold mt-2">vs $20-60 on Thumbtack</p>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600" />
